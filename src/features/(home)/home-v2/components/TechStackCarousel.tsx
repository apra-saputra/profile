    ...
    >
      <CarouselContent className="-ml-1">
        {techCategoriesMemo.map((category, index) => (
          ...
          >
            <div className="bg-gradient-to-r from-accent to-primary p-4 rounded-2xl shadow-lg h-full px-4 py-2 text-center flex items-center justify-between w-full gap-x-3">
              <img src={category.logo} alt="logo" className="aspect-square h-6" />
