...
import IntroAnimation from "../../commons/components/IntroAnimation";
import { programings, techstacks } from "@/libs/constants/techstack";

const Techstacks = () => {
  return (
    <section
      className="flex items-center justify-center w-full mt-2 md:px-0 px-2 md:h-full h-[500px]"
      id="tech_stack"
    >
      <div className="flex flex-col md:justify-start justify-start md:h-2/3 h-full items-center w-full gap-10 relative">
